...
export function WhySabi() {
  ...
  const content = {
    ...
    am: {
      ...
      p1: "የሳቢ የቁጠባ እና ብድር ኅብረት ስራ ማህበር ሲቋቋም ታሪኩ እንዲህ ነው። በአንድ ወቅት ተመሳሳይ የካፒታል አቅረቦት ያስፈለጋቸው ባለራዕይ ወጣት ጓደኛሞች ህልማቸውን ለማሳካት ብዙ ርቀት መጓዝ አዳገታቸው። በሀገራችን ያለው ነባር የህብረት ስራ ማህበራት የሚያቀርቡት የፋይናንስ አገልግሎት ከፍላጎታችን ጋር የተስማማ ሆኖ አላገኘነውም። ለዘመናዊው ህይወት ፍጥነት ፣ ለአዲሱ ትውልድ ትጋት እና ህልም የተገነባ ተቋም ገበያ ላይ በበቂ አላገኘንም። ቀልጣፋ ፣ ግልጽ እና በስኬታችን ላይ ከልብ መዋዕለ ንዋይ የሚያፈስ የፋይናንስ አጋር እንፈልግ ነበር። ",
