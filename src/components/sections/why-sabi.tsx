...
export function WhySabi() {
  ...
  const content = {
    en: {
      ...
      subtitle: "Because finance hasn't kept up with the dreamers, the builders, the new Ethiopian generation. We decided to build the bridge.",
    ...
    am: {
      title: "ለምን ሌላ ሳኮ አስፈለገ? ለምን ሳቢ?",
      subtitle: "ፋይናንስ ከህልመኞች፣ ከሰሪዎች፣ ከአዲሱ የኢትዮጵያ ትውልድ ጋር እኩል አልተጓዘም። እኛ ድልድዩን ለመገንባት ወሰንን።",
      ...
      p2: "ለዚህም ነው ሳቢን የፈጠርነው። እኛ አባሎቹን የሚያስቀድም የህብረት ስራ ማህበር የመገንባት ራዕይ ይዘን የተሰባሰብን φιλόδοξοι ኢትዮጵያውያን ስብስብ ነን። ቴክኖሎጂን ለይስሙላ ሳይሆን ልዩ እናቀላል አገልግሎት ለመስጠት እንጠቀምበታለን። ሳቢ ከሳኮ በላይ ነው፤ በማህበረሰቡ የተገነባ፣ ለማህበረሰቡ የቆመ የማጎልበቻ መድረክ ነው።"
    }
  };
